...
if tr_url and tr_user and tr_pw:
    ...
    if all_cases:
        ...
        with col_search:
            ...
            q_input = st.text_input("", value=st.session_state.q_text, placeholder="請輸入查詢關鍵字，多個請以空格格開", label_visibility="collapsed")
        ...
        if st.session_state.q_text:
            ...
            for c in all_cases:
                ...
                for t in terms:
                    ...
                    f_t = any(w in title_l for w in exp)
