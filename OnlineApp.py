...
if tr_url and tr_user and tr_pw:
            ...
            if scored_results:
                ...
                for _, item, u_info in scored_results:
                    ...
                    if u_info.get("is_active", True):
                        status_emoji, author_style = "🟢", "color: #4CAF50; background: rgba(76, 175, 80, 0.15); border: 1.5px solid #4CAF50;"
                    else:
                        status_emoji, author_style = "🔴", "color: #ff4b4b; background: rgba(255, 75, 75, 0.15); border: 1.5px solid #ff4b4b;"
    ...
    else: st.error(f"❌ 同步失敗，請檢查側邊欄連線資訊。")
