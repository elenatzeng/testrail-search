...
if tr_url and tr_user and tr_pw:
    ...
    if all_cases is not None:
        ...
        with col_search:
            ...
            q_input = st.text_input("", value=st.session_state.q_text, placeholder="多關鍵字空格分隔", label_visibility="collapsed")
        ...
        if final_query:
            ...
            for _, item, u_info in scored_results:
                ...
                st.markdown(f'<div class="case-path-text">{path_map.get(item.get("section_id"), "")}</div>', unsafe_allow_html=True)
