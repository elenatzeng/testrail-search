...
SEARCH_DICTIONARY = [
    ...
    ["transfer", "轉帳", "转账", "Transfer", "劃轉", "划转"],
    ["Wallet", "錢包", "钱包"],
    ["network fee", "網路手續費", "网络手续费", "gasFee"],
    ["exchange", "閃兌", "闪兑"],
    ["crypto", "虛擬幣", "虛擬貨幣", "加密貨幣", "數字貨幣", "Crypto"],

    # --- [auManage] 權限與成員管理 ---
    ["auManage", "權限管理", "权限管理", "Authority Management", "access", "authority"],
    ...
    ["resetPassword", "重置密碼", "重置密码", "Reset Password"],
    ["accManage", "帳號管理", "账号管理", "Account Management"],
